    ...
    <GuideArticleShell
      ...
      intro={
        <div className="font-serif text-muted text-base leading-relaxed max-w-2xl space-y-4">
          ...
          <p className="font-sans text-muted text-xs font-bold tracking-widest uppercase pt-1">
      ...
      beforeComparison={
        ...
        <section className="mb-12 max-w-2xl">
          ...
          <div className="bg-white border border-[#d4c9b0] p-6 font-serif text-muted text-base leading-loose space-y-2">
            <p>
          ...
          <p className="font-sans font-bold text-dark mt-6 leading-relaxed">
            If your phone supports eSIM, this is the simplest and best option. No
            reason to use anything else.
          </p>
          <p className="font-serif text-muted mt-6 leading-relaxed">
            If you want maps and trains working before you leave the airport, do
            this:
          </p>
          <p className="font-serif text-muted text-sm leading-relaxed mt-2">
            This is easier to do before arrival.
          </p>
          <p className="font-serif text-xs text-muted/70 leading-relaxed mt-2 mb-2">
          ...
          <TrackedCtaLink
            href="/guides/airalo-vs-ubigi-japan"
            label="esim"
            className="inline-block font-sans font-bold text-sm text-rust hover:text-maroon transition-colors duration-150 mt-5"
          >
      ...
      afterComparison={
        ...
        <section className="mb-12 max-w-2xl space-y-10">
          ...
          <p className="font-serif text-muted leading-relaxed mb-3">
            You will rely on maps and trains constantly.
          </p>
          <Link
            href="/guides/japan-trains"
            className="inline-block font-sans font-bold text-sm text-rust hover:text-maroon transition-colors duration-150 mb-10"
          >
          ...
          <div>
            ...
            <p className="font-serif text-muted leading-relaxed mb-2">
          ...
          <div>
            ...
            <p className="font-serif text-muted leading-relaxed mt-4 mb-2">
              Need help after landing?
            </p>
            <Link
              href="/guides/japan-airport-to-city"
              className="inline-block font-sans font-bold text-sm text-rust hover:text-maroon transition-colors duration-150"
            >
        ...
        <section className="mb-12 max-w-2xl">
          ...
          <p className="font-display text-dark text-2xl tracking-wide mt-8">
            {`That's it. No complicated setup, no wasted time.`}
          </p>
          <p className="font-serif text-muted leading-relaxed mt-6">
        ...
        <section className="mb-12 max-w-2xl">
          ...
          <p className="font-serif text-muted leading-relaxed mb-3 mt-12">
          ...
          <Link
            href="/guides/japan-trains"
            className="inline-block font-sans font-bold text-sm text-rust hover:text-maroon transition-colors duration-150 mt-6"
          >
            Navigate Japan trains on day one →
          </Link>
        </section>
        ...
        <section className="mb-12">
          <div className="bg-dark px-8 py-10 max-w-2xl">
            <h2
              className="font-display text-tan tracking-widest text-xl mb-6"
            >
              CHECK LATEST PRICES ///
            </h2>
            <p className="font-serif text-[#aab4be] text-sm leading-relaxed mb-6">
              If you want current prices before you pay, do this:
            </p>
            <p className="font-serif text-[#aab4be] text-xs leading-relaxed mb-4">
              Doing this when you have time beats trying to compare plans on
              arrivals WiFi.
            </p>
            <p className="font-serif text-[#8a96a6] text-xs leading-relaxed mb-4">
              Based on real use in Japan.
            </p>
            <p className="font-sans font-bold text-xs text-tan mb-4 tracking-wide">
              Recommended options
            </p>
            <ul className="space-y-5 list-none pl-0">
              <li>
                <p className="font-sans font-bold text-xs tracking-widest uppercase text-tan mb-2">
                  Best overall
                </p>
                <TrackedOutboundSimLink
                  href={AIRALO_URL}
            ...
            <div className="border-t border-[#3a3a3a] mt-8 pt-6">
              <p className="font-sans text-[#667788] text-xs font-bold tracking-widest uppercase leading-relaxed">
        ...
        <section className="mb-12 max-w-2xl">
          ...
          <dl className="space-y-8">
            <div>
              <dt className="font-sans font-bold text-dark text-base mb-2">
                Can I use my SIM card in Japan?
              </dt>
              <dd className="font-serif text-muted leading-relaxed m-0">

...
const btnClass =
  "inline-flex w-full shrink-0 items-center justify-center rounded-md bg-maroon px-4 py-2 font-sans text-xs font-bold uppercase tracking-widest text-white transition-colors duration-150 hover:bg-rust sm:w-auto";

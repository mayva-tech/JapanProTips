...
const checkboxLabel =
  "flex cursor-pointer items-start gap-3 rounded-md border border-paper-edge bg-paper px-3 py-2.5 font-sans text-sm font-semibold text-dark transition-colors duration-150 hover:border-rust/40 has-[:checked]:border-maroon has-[:checked]:bg-maroon/10 has-[:checked]:text-maroon";

...
const primaryBtn =
  "inline-flex w-full items-center justify-center bg-maroon px-8 py-4 font-sans text-sm font-bold uppercase tracking-widest text-white hover:bg-rust transition-colors duration-150 sm:w-auto sm:min-w-[240px]";
const secondaryBtn =
  "inline-flex w-full items-center justify-center border border-dark px-6 py-3.5 font-sans text-sm font-bold uppercase tracking-widest text-dark hover:bg-dark hover:text-cream transition-colors duration-150 sm:w-auto sm:min-w-[240px]";
